        ...
        class ClimbingApp {
            ...
            classifyAssistantIntent(text) {
                ...
                if (/(как доехать|как добраться|как попасть|проложи|проложить|навигатор|маршрут до|дорогу до|доехать до)/i.test(t)) {
                    return 'navigate';
                }
                if (/(добав(?:ь|ить)|создай|создать|новый район|новый сектор|новую трассу|новый болдер|новый боулдер)/i.test(t)) {
                    return 'create';
                }
                return 'search';
            }
